...
function Dashboard() {
  ...
  async function getApiData() {
    let response = await fetch("http://10.0.154.138:5000/system/health");
  ...
  return (
    <div className=" flex flex-col mt-10 w-[1200px]">
        ...
        {apiData === null ? (
          ...
          <div className=" w-[90%]  ">
            ...
            <div className="flex items-center  gap-24 ">
              <div className="bg-amber-200 w-44 h-36 rounded-4xl flex  flex-col justify-center items-center shadow-black-500 shadow-xl ">  
                <Stack
